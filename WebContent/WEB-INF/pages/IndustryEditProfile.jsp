...
<title>Industry Edit Profile</title>
...
<div class="header">
	...
	<form action="industryeditprofile.hr" method="post">
		
		<h2 align="center"> Industry Edit Profile</h2>
			...
			<table id="table1" ; cellspacing="5px" cellpadding="5%"
	          ...
	          <tr>
	            ...
	            <tr>
					...
					<td><input id="name" type="text" value="${industry.industryName}"
						name="industryName"  required></td>
				</tr>
	            <tr>
					<td align="right">Email:</td>
					<td><input type="email" name="industryEmail" value="${industry.industryEmail}"
				...
				<tr>
						...
						<td><input id="Mob" type="text" name="industryMob" value="${industry.industryMob}"
							style="width: 200px;" title="Format: (e.g. 10 digits)" pattern="^\d{10}$"  required></td>
					</tr>
	            <tr>
					<td align="right">Location:</td>
					<td><select id="address" value="${industry.industryAddress}"
