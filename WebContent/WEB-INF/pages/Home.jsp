...
<body>
	...
	<div class="layout">
        <marquee id="alert"  width="100%" direction="left" height="30%">
             This is to inform you that Government of Maharashtra has introduced new Scholarship Schemes. Apply fast, The last date for applying is <U>30 December 2019</U>.
        </marquee>
		<div class="updates">
			<div class="marquee1">
				<h4>
				...
				<p style="background-color: #CCFFA3">Ministry is going to introduce new Scholarship Schemes under <U>Pradhan Mantri Scholarship Scheme(PMSS) 2019</U>.</p>
		...
		<div class="description">
			<div class="marquee1">
				 ...
				 <p><left>National Scholarship portal is an education related portal. National Scholarship portal is a project developed with the main aim of providing an easy and efficient way for applying and getting a scholarship for students in need of it.Government has offered various scholarships based on various criteria like merit,minority and specially for girls to encourage them for Education.
				 </left></p>
                 <h3>Various Schemes available at our Portal:</h3>
                 <p>Post Matric Scholarship<br>
                    National Merit Scholarship<br>
                    Scholarship for girls<br>
				 </p>
			</div>
		</div>
		...
		<div class="slogin">
			<div class="marquee1">
				...
				<p><font color="#2B6CF9">For any Queries regarding latest Scholarships, Contact us on toll free number <u>1800 2700 2700</u> or e-mail us at <u>apnascholarship@gov.in</u></font></p>
