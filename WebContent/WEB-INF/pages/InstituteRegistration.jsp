...
<div class="header">
	...
	<form action="instituteRegistration.hr" method="post">
		
		<h2 align="center">Fresh Institute Registration Form</h2>
			...
			<table id="table1" ; cellspacing="5px" cellpadding="5%"
	           ...
	           <tr>
					...
					<td><input type="text" style="width: 200px;" placeholder="####"
						name="instituteCode" id="aadhar_no" title="Format: (e.g. #### digits)" pattern="^\d{4}$"  required></td>
				</tr>
	            ...
	            <tr>
					...
					<td><input type="email" name="instituteEmail"
				...
				<tr>
						...
						<td><input id="insititueMob" type="text" name="instituteMobile"
							style="width: 200px;" title="Format: (e.g. 10 digits)" pattern="^\d{10}$"  required></td>
					</tr>
	            <tr>
					<td align="right">Location:</td>
					<td><select id="address" 
						name="instituteAddress" onchange="optionCheck()" required>
