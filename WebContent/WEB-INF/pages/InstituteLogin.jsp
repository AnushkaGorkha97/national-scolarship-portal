...
<div class="header">
	...
	<div class="container">
		<h1 align="center">INSTITUTE LOGIN</h1>
		<form action="institutedashboard.hr" method="post">
			<table id="table1" cellspacing="5px" cellpadding="5%" align="center">
				<tr>
					<td align="right">Enter your username:</td>
					<td align="right"><input type="text" name="instituteCode" /></td>
				</tr>
				<tr>
					<td align="right">Enter your password:</td>
					<td align="right"><input type="password" name="institutePassword" /></td>
				</tr>
			</table>
