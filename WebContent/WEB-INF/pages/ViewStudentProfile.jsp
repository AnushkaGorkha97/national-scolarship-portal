...
<div class="header">
	...
	<nav id="navbar"> 
		...
		<a href="viewstudentcertifiedcourse.hr?courseId=${courseId}" class="menu">GO BACK TO STUDENT LIST</a> 
		<a href="industrylogout.hr" class="menu">LOGOUT</a> 
	</nav>
	
	
	
	<form action="industrysendjob.hr?studentAadharNo=${student.studentAadharNo}&courseId=${courseId}" method="post">
	 ...
	 <c:forEach items="${courseList}" var="std">
	  ...
	  <table id="table1" ; cellspacing="5px" cellpadding="5%"
				; align="center">
	  <tr>
				    <td align="right"> Job To Select:</td>
					<td><select id="input" name="jobId" 
				...
				<button align ="center" id="submit" type="submit">Send Job</button>
