...
<div class="header">
	...
	<form action="industrySetPassword.hr" method="post"
	onsubmit="return (validate() && checkPassword())">
	
	<h2 align="center">SET PASSWORD FOR INDUSTRY</h2>
			...
			<table id="table1" ; cellspacing="5px" cellpadding="5%"
				...
				<<tr>
					...
					<td><input type="password" style="width: 200px;"
						name="industryPassword" id="set_pass" pattern="(?=^.{8,}$)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" title="Password min 8 characters. At least one UPPERCASE and one lowercase letter" required /></td>
				</tr>
